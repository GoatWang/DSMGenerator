...
# def get_line_vecs_new(idxs, opk, lxyz, px=0, py=0, rows=13824, cols=7680, pixel_size=0.012, focal_length=120):
...
def get_PQ(aerotri_params1, aerotri_params2, kp1_npidxs, kp2_npidxs):
    ...
    return cal_dist(vecs1, spts1, vecs2, spts2) # pxyz1, pxyz2, dists_ecu, dists_blk
